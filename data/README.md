...
- The filtered bulk of data as a [.csv file](https://github.com/utku-ayan/open-scholarship-project-2026/blob/main/data/europeana_wwi_medals_29.04.2026.csv), which includes the following columns from the queried data (created on 29.04.2026):
