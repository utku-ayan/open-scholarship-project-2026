...
- 8. A new metadata statistical analysis report was created, that only analyses the entries with "Europe" in their country column. This report includes the frequency report of the default language column of these entries. The plan is to infer the country of entries from the default language in their 'dcLanguageLangAware.def' column.
