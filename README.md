...
- 7. The following data visualisation was created as a next step of the process of examining the data providers included in the [data gathered](https://github.com/utku-ayan/open-scholarship-project-2026/blob/main/data/metadata_statistics_report.txt), which also faces a similar issue as the data about the countries of origin, however I intend to continue with these results: <img width="1536" height="1024" alt="data provider statistics charts" src="https://github.com/user-attachments/assets/cf7c9be6-bc0e-4f43-8bba-957981f3ad7a" />
